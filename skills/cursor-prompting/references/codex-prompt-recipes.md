...
Use these as starting templates for Cursor task prompts or other Cursor/GPT-5.4 prompt construction.
...
```xml
<task>
Diagnose why this existing prompt is underperforming and propose the smallest high-leverage changes to improve it for Cursor or GPT-5.4.
</task>
